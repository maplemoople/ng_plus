			...
			if room == Line2{
					...
					//times to beat and whatnot
						...
						if bestLetterScore != ("Z"){
							...
							draw_set_color(c_black);
							draw_text_outlined(display_get_gui_width() * 90/100, display_get_gui_height() * 99 / 100, c_white, c_black, 6, string(collectedHUD(bestCollected)));
							// Best Grade Display
							draw_set_color(bgradeColor);
							...
							draw_set_color(c_black);
							draw_text_outlined(display_get_gui_width() * 10/100, display_get_gui_height() * 99 / 100, c_white, c_black, 6, string(collectedHUD(collected)));
						} else {
							draw_set_font(fTitle)
							draw_set_halign(fa_left)
							draw_set_valign(fa_bottom);
				...
				if room == Room21{
						...
						//times to beat and whatnot
							...
							if bestLetterScore2 != ("Z"){
								...
								// Best Time Display
								draw_set_color(btCol)
								draw_text_outlined(display_get_gui_width() * 90/100, display_get_gui_height() * 87 / 100, c_white, btCol, 6, "Time: " + string(bestTime2));
								// Best Death Display
								draw_set_color(bdCol)
								draw_text_outlined(display_get_gui_width() * 90/100, display_get_gui_height() * 91 / 100, c_white, bdCol, 6, "Deaths: " + string(bestDeaths2));
								// Best Collected DIsplay
								draw_set_color(c_black);
								draw_text_outlined(display_get_gui_width() * 90/100, display_get_gui_height() * 99 / 100, c_white, c_black, 6, string(collectedHUD(bestCollected2)));
								// Best Grade Display
								draw_set_color(bgradeColor);
								draw_text_outlined(display_get_gui_width() * 90/100, display_get_gui_height() * 95 / 100, c_white, bgradeColor, 6, "Grade: " + string(bestLetterScore2));
